...
<input type="hidden" name="hosted_button_id" value="6PDHASWDVKTQE">
<table>
<tr><td><input type="hidden" name="on0" value="Sprocket Validator">Sprocket Validator</td></tr><tr><td><select name="os0">
	<option value="Sprocket Validator">Sprocket Validator $495.00 USD</option>
	<option value="Sprocket Validator with 1 year support">Sprocket Validator with 1 year support $695.00 USD</option>
</select> </td></tr>
</table>
